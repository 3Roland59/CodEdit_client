        ...
        <Card className="text-center py-12">
          ...
          <CardContent>
            ...
            <Link to="/dashboard/my-challenges">
              <Button className="mt-4 rounded-3xl gradient-bg">
                Back to Challenges
              </Button>
            </Link>
          </CardContent>
      ...
      <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
          ...
          <Link to={`/dashboard/submissions/${challenge.id}`}>
            <Button className="rounded-3xl gradient-bg w-full sm:w-auto">
      ...
      <div className="space-y-6">
                ...
                <Card key={testCase.id} className="p-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="bg-gray-50 p-2 rounded text-sm">
                        <span className="text-gray-500">
                          ({testCase.inputDataType.replace(";", ", ")})
                        </span>{" "}
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 p-2 rounded text-sm">
                        <span className="text-gray-500">
                          ({testCase.outputDataType.replace(";", ", ")})
                        </span>{" "}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Share this link along with its challenge key with your students to
              give them access.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col sm:flex-row gap-2">
              <div className="flex-1 bg-gray-50 p-3 rounded border text-sm font-mono break-all">
